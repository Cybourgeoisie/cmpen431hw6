...
il1 = ["il1:%s:%s:%s:l" %(x,(y*8),z) for x in [256,512] for y in [4,8,16] for z in [1,2,4]]

makeConfigs("optimal_cache_L1_missing_cases", 
	{
...
# Run tests
#runBenchmarksOnTestSets(["optimal_cache_L1_missing_cases"])

# Retrieve results
#extractDataFromResults(["sim_IPC"], ["optimal_cache_L1_missing_cases"])
